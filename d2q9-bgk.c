...
//     {
// #pragma omp simd aligned(speed_0, speed_1, speed_2, speed_3, speed_4, speed_5, speed_6, speed_7, speed_8, \
...
#pragma omp simd aligned(speed_0, speed_1, speed_2, speed_3, speed_4, speed_5, speed_6, speed_7, speed_8, \
        ...
        for (int ii = 0; ii < params.nx; ii++)
        {
            ...
            ** respecting periodic boundary conditions (wrap around) */
            ...
            /* propagate densities from neighbouring cells */
            float speed0 = speed_0[index];
            float speed1 = speed_1[x_w + jj * params.nx];
            float speed2 = speed_2[ii + y_s * params.nx];
            float speed3 = speed_3[x_e + jj * params.nx];
            ...
            /* Create a mask: 1.0f for obstacles, 0.0f for fluid */
            ...
            /* update running totals - only count fluid cells */
            tot_u += is_fluid * sqrtf((u_x * u_x) + (u_y * u_y));
            tot_cells += (int)is_fluid;  /* equivalent to adding 1 only for fluid cells */
            ...
            /* For obstacles: mirror the speeds; For fluid: perform relaxation */
